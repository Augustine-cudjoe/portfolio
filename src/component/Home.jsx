...
function Home() {
 ...
 <VerticalTimeline layout='2-columns'>
  ...
  >
    ...
    <ul className='space-y-3'>
      ...
      <footer className="main-footer text-bg-dark py-10  border-t border-white px-[5%]">
 <div className="container">
     <div className="grid grid-cols-1 md:items-start md:grid-cols-4 md:gap-10 lg:gap-5 space-y-3">
        ...
        <div className="">
        <h6 className='font-bold text-lg text-white flex justify-start md:ml-[10px] lg:ml-[20px]  pb-3'>Social Media</h6>
           
        <p className='flex justify-between flex-col items-start space-y-3  md:flex-wrap lg:flex-nowrap'>
         <LinkRouter to="#" className="flex items-center px-2  justify-center gap-1 md:gap-2 my-1 lg:my-0 lg:mr-[15px] lg:ml-[20px] md:ml-[10px] w-full md:w-10/12 transition-all h-[40px] bg-transparent  border-2 border-[#0ef] rounded-full text-[#0ef] text-[20px] hover:bg-white hover:text-[#0ef] hover:shadow-white hover:border-white box-border ">
         ...
         <LinkRouter to="#" className="flex items-center px-2  justify-center gap-1 md:gap-2 my-1 lg:my-0 lg:mr-[15px] lg:ml-[20px]  md:ml-[10px] w-full md:w-10/12 items-center transition-all h-[40px] bg-transparent  border-2 border-[#0ef] rounded-full text-[#0ef] text-[20px] hover:bg-white hover:text-[#0ef] hover:shadow-white hover:border-white box-border">
